...
gSounds = {
	['music-jazzy'] = love.audio.newSource('sounds/music3.mp3','static'),
	['music-happy'] = love.audio.newSource('sounds/music2.mp3','static'),
	['music-intense'] = love.audio.newSource('sounds/music2.mp3','static'),
...
gTextures = {
	...
	['shiny'] = love.graphics.newImage('graphics/shiny_particle.png')
}
